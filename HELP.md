...
* The following dependencies are not known to work with Spring Native: 'Spring Session, Spring REST Docs'. As a result, your application may not work as expected.
* The original package name 'sms.example.student-management-system' is invalid and this project uses 'sms.example.studentmanagementsystem' instead.
...
```
$ docker run --rm -p 8080:8080 student-management-system:0.0.1-SNAPSHOT
```
...
```
$ target/student-management-system
```
